...
class OneSignalClient {
	...
	public function sendNotificationToUser($contents, $userId, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
	 ...
	 * @param null $subtitle
	 */
	public function sendNotificationToExternalUser($contents, $userId, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
		if (is_string($contents)) {
			$contents = [
				"en" => $contents
			];
	...
	public function sendNotificationUsingTags($contents, $tags, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
		if (is_string($contents)) {
			$contents = [
				"en" => $contents
			];
	...
	public function sendNotificationToAll($contents, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
		if (is_string($contents)) {
			$contents = [
				"en" => $contents
			];
	...
	public function sendNotificationToSegment($contents, $segment, $url = null, $data = null, $buttons = null, $schedule = null, $headings = null, $subtitle = null) {
		if (is_string($contents)) {
			$contents = [
				"en" => $contents
			];
